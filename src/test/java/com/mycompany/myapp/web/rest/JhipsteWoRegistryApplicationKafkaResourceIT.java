...
class JhipsteWoRegistryApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsteWoRegistryApplicationKafkaResource kafkaResource = new JhipsteWoRegistryApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipste-wo-registry-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipste-wo-registry-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
