...
@RestController
@RequestMapping("/api/jhipste-wo-registry-application-kafka")
public class JhipsteWoRegistryApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsteWoRegistryApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsteWoRegistryApplicationKafkaResource(KafkaProperties kafkaProperties) {
